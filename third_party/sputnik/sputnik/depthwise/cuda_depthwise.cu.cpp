...
hipError_t CudaDepthwiseBiasRelu(int n, int c, int h, int w,
...
hipError_t CudaDepthwise(int n, int c, int h, int w,
                          const float* __restrict__ in, int kernel_size,
                          int padding, int stride,
                          const float* __restrict__ filters,
                          float* __restrict__ out, hipStream_t stream) {
...
template <int kBlockItemsX, int kBlockItemsY, int kThreadItemsX,
          int kThreadItemsY>
hipError_t CudaDepthwiseEx(int n, int c, int h, int w,
                            const float* __restrict__ in, int kernel_size,
                            int padding, int stride,
                            const float* __restrict__ filters,
                            const float* __restrict__ bias,
...
#define INSTANTIATE_TILED(fn, bx, by, tx, ty)                               \
  template hipError_t fn<bx, by, tx, ty>(int, int, int, int, const float*, \
                                          int, int, int, const float*,      \
                                          const float*, float*, hipStream_t)
